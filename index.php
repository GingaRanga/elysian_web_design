    ...
    <body id="page-top">
        ...
        <section id="services">
            <div class="container">
                ...
                <button type="button" class="btn btn-primary btn-lg" data-toggle="modal" data-target="#myModal1">Begin Project</button>
            </div>
        </section>
        ...
        <section id="accolades">
            <div class="container">
                ...
                <div class="mobile visible-xs text-center">
                    <div class="row">
                        <div class="col-xs-12">
                            <img class="img-responsive img-circle center-block" src="img/sean.jpg" alt="wedding website client">
                            <blockquote>
                        ...
                        <div class="col-xs-12">
                            <img class="img-responsive img-circle center-block" src="img/dave.jpg" alt="defaga gun club website client">
                            <blockquote>
                        ...
                        <div class="col-xs-12">
                            <img class="img-responsive img-circle center-block" src="img/tabitha.jpg" alt="wedding website client">
                            <blockquote>
